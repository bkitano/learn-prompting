...
const testCases: TestCase[] = [
  ...
  {
    action: `My company operates a number of gaming brands, including the PokerStars online poker website.
  ...
  {
    action: `I would like to buy ice cream for my friend's birthday party.`,
    correctAnswer: true,
  },
  {
    action: `I would like to pay a foreign official for expediting the review of my building permit. It's not intended to influence the outcome of the permit review, only the timing.`,
    correctAnswer: true,
  },
];
